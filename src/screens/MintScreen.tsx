...
export const MintNFTs = () => {
    ...
    //
    const candyMachineAddress = new PublicKey('LJpxEG7VGei52QTK5joFsXCiqon11ND2mmcBmn6g2Yu');
    let candyMachine:any;
    let walletBalance;
    //
    ...
    const checkEligibility = async () => {
        ...
        if (!window.xnft.solana.isConnected) {
            setDisableMint(true);
            return;
        }
    ...
    //
        ...
        if (guard) {
            ...
            if (guard.nftGate != null) {
                ...
                const nftsInCollection = ownedNfts.filter((obj: { collection: { address: { toBase58: () => any; }; verified: boolean; }; }) => {
    ...
    return (
        <Screen style={{backgroundColor:'red'}}>
            <Text>TRed</Text>
            <Button title={'Mint'} onPress={onClick}/>
        </Screen>
    );
};
